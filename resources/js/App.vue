      ...
      <div class="right">
        <nav class="main-nav">
          ...
          <template v-else>
            ...
            <RouterLink :to="{ name: 'user.bookings' }">Bookings</RouterLink>
          </template>
        </nav>

        <div v-if="auth.loggedIn" class="notif">
          <RouterLink class="notif-btn" :to="{ name: 'notifications.index' }">
            Notifications
...
.main-nav a.router-link-active{background:#0d6efd;color:white;}
